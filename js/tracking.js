      ...
      if (data.error) {
        ...
        result.innerHTML = `
          <table>
            ...
            <tr><th>Date Booked</th><td>${data["Date Booked"]}</td></tr>
            <tr><th>Delivered On</th><td>${data["Delivered On"] || "In Transit"}</td></tr>
          </table>

          ${data["POD Link"] ? `<a class="pod-button" href="${data["POD Link"]}" target="_blank">View / Download POD</a>` : ""}
        `;
      }
    })
    .catch(error => {
